...
declare class MDCActionSheetController extends UIViewController implements MDCElevatable, MDCElevationOverriding {
	...
	alwaysAlignTitleLeadingEdges: boolean;
	...
	traitCollectionDidChangeBlock: (p1: MDCActionSheetController, p2: UITraitCollection) => void;
...
declare class MDCAlertController extends UIViewController implements MDCElevatable, MDCElevationOverriding {
...
declare class MDCAppBarNavigationController extends UINavigationController {
	...
	traitCollectionDidChangeBlockForAppBarController: (p1: MDCFlexibleHeaderViewController, p2: UITraitCollection) => void;
...
declare class MDCBannerView extends UIView implements MDCElevatable, MDCElevationOverriding {

	static alloc(): MDCBannerView; // inherited from NSObject

	static appearance(): MDCBannerView; // inherited from UIAppearance

	static appearanceForTraitCollection(trait: UITraitCollection): MDCBannerView; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedIn(trait: UITraitCollection, ContainerClass: typeof NSObject): MDCBannerView; // inherited from UIAppearance

	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): MDCBannerView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): MDCBannerView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): MDCBannerView; // inherited from UIAppearance

	static new(): MDCBannerView; // inherited from NSObject

	bannerViewLayoutStyle: MDCBannerViewLayoutStyle;

	dividerColor: UIColor;

	readonly imageView: UIImageView;

	readonly leadingButton: MDCButton;
	...
	readonly trailingButton: MDCButton;

	traitCollectionDidChangeBlock: (p1: MDCBannerView, p2: UITraitCollection) => void;
...
declare const enum MDCBannerViewLayoutStyle {

	Automatic = 0,

	SingleRow = 1,

	MultiRowStackedButton = 2,

	MultiRowAlignedButton = 3
}
...
declare class MDCBaseCell extends UICollectionViewCell implements MDCElevatable, MDCElevationOverriding {
	...
	traitCollectionDidChangeBlock: (p1: MDCBaseCell, p2: UITraitCollection) => void;
...
declare class MDCBottomAppBarView extends UIView implements MDCElevatable, MDCElevationOverriding {
	...
	traitCollectionDidChangeBlock: (p1: MDCBottomAppBarView, p2: UITraitCollection) => void;
...
declare class MDCBottomDrawerPresentationController extends UIPresentationController {
	...
	shouldAlwaysExpandHeader: boolean;

	shouldIncludeSafeAreaInContentHeight: boolean;
	...
	traitCollectionDidChangeBlock: (p1: MDCBottomDrawerPresentationController, p2: UITraitCollection) => void;
...
declare class MDCBottomDrawerViewController extends UIViewController implements MDCBottomDrawerPresentationControllerDelegate, MDCElevatable, MDCElevationOverriding {
	...
	traitCollectionDidChangeBlock: (p1: MDCBottomDrawerViewController, p2: UITraitCollection) => void;
...
declare class MDCButtonBar extends UIView {
	...
	traitCollectionDidChangeBlock: (p1: MDCButtonBar, p2: UITraitCollection) => void;
...
declare class MDCButtonBarButton extends MDCFlatButton {
	...
	static systemButtonWithImageTargetAction(image: UIImage, target: any, action: string): MDCButtonBarButton; // inherited from UIButton
}
...
declare class MDCFeatureHighlightView extends UIView {
	...
	traitCollectionDidChangeBlock: (p1: MDCFeatureHighlightView, p2: UITraitCollection) => void;
}
...
declare class MDCFeatureHighlightViewController extends UIViewController {
	...
	traitCollectionDidChangeBlock: (p1: MDCFeatureHighlightViewController, p2: UITraitCollection) => void;
...
declare class MDCFlexibleHeaderContainerViewController extends UIViewController {
	...
	traitCollectionDidChangeBlock: (p1: MDCFlexibleHeaderContainerViewController, p2: UITraitCollection) => void;
...
declare class MDCFlexibleHeaderView extends UIView implements MDCElevatable, MDCElevationOverriding {
	...
	traitCollectionDidChangeBlock: (p1: MDCFlexibleHeaderView, p2: UITraitCollection) => void;
...
declare class MDCFlexibleHeaderViewController extends UIViewController implements UIScrollViewDelegate, UITableViewDelegate {
	...
	traitCollectionDidChangeBlock: (p1: MDCFlexibleHeaderViewController, p2: UITraitCollection) => void;
...
declare class MDCHeaderStackView extends UIView {
	...
	traitCollectionDidChangeBlock: (p1: MDCHeaderStackView, p2: UITraitCollection) => void;
}
...
declare class MDCNavigationBar extends UIView implements MDCElevatable, MDCElevationOverriding {
	...
	traitCollectionDidChangeBlock: (p1: MDCNavigationBar, p2: UITraitCollection) => void;
...
declare class MDCPageControl extends UIControl implements UIScrollViewDelegate {
	...
	traitCollectionDidChangeBlock: (p1: MDCPageControl, p2: UITraitCollection) => void;
...
declare class MDCSlider extends UIControl implements MDCElevatable, MDCElevationOverriding {
...
declare class MDCTextInputControllerOutlined extends MDCTextInputControllerBase {
	...
	brandNewCornerRadiusOutlined: number;

	applyThemeWithScheme(scheme: MDCContainerScheming): void;

	setFullPading(fullPadding: number): void;

	setPlaceholderBorderRectHeight(placeholderBorderRectHeight: number): void;

	setPlaceholderLabelLeadingAdjust(placeholderLabelLeadingAdjust: number): void;

	setPlaceholderPadding(placeholderPadding: number): void;

	setThreeQuartersPadding(threeQuartersPadding: number): void;
}
